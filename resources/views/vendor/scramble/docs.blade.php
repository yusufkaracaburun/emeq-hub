...
<head>
    ...
    <style>
        ...
        /* Stoplight Elements plakt onderaan de sidebar een "Powered by Stoplight"-
           link. Scramble heeft er geen config voor; vandaar deze view-override. */
        elements-api a[href*="stoplight.io"] {
