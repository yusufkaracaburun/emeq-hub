...
class JournalsTest extends TestCase
{
    ...
    public function test_journals_forwards_to_financial_journals_endpoint(): void
    {
        MockClient::global([
            GetJournals::class => MockResponse::make([
                'd' => ['results' => [['ID' => 'jnl-1', 'Code' => '70', 'Description' => 'Verkoop', 'Type' => 20]]],
            ], 200),
        ]);
        ...
        $this->withHeader('Authorization', "Bearer {$token}")
            ...
            ->getJson('/v1/exact/journals?$top=1')
            ->assertOk()
            ->assertJsonPath('d.results.0.Code', '70');
    ...
    public function test_journals_requires_exact_ability(): void
    {
        [$consumer] = $this->consumerWithExactConnection();
