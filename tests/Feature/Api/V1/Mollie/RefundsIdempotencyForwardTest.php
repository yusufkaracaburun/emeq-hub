...
/**
 * Bewijst D-06 forward-pad voor POST /v1/mollie/payments/{id}/refunds —
 * gap-closure Plan 05a-06 (verificatie-truth #12 / CR-01). Refunds zijn
 * financieel risico bij retry-storm zonder Idempotency-Key forward.
 */
