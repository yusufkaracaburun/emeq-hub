...
class RobotsController extends Controller
{
    ...
    /**
     * Crawlers die content ophalen om modellen te trainen. Die leveren geen
     * verkeer op, dus ze worden geweigerd.
     *
     * Deze lijst stond eerder in Cloudflare's Managed robots.txt, dat vóór het
     * onze werd geplakt. Die management staat inmiddels uit — één bestand per
     * host — dus we dragen 'm hier zelf.
     *
     * @var list<string>
     */
