...
| grill-first | always-on | Never jump to plan or implementation from an issue/PRD/spec — open with grill questions first, then name the ai-kit phase and skill that carry the work |
