...
return [
     ...
     */
    'notifications' => [
        // Alleen fouten en ongezonde backups alerten; succes-events zouden
        // (met MAIL_MAILER=log op prod) alleen log-ruis geven. Echte alerting
        // (mail/Slack) volgt met de monitoring-gap #53.
        'notifications' => [
        ...
        'mail' => [
            'to' => env('BACKUP_NOTIFICATION_MAIL', 'support@emeq.nl'),
