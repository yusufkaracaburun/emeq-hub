...
return [
    ...
    */
    ...
    'api_middleware' => [
        // Gewone web-sessie i.p.v. Sanctum-stateful: same-origin admin-tool, geen
        // cross-origin SPA. EnsureFrontendRequestsAreStateful vereist dat de host
        // in api_stateful_domains/sanctum.stateful staat — anders is de API-XHR
        // stateless → $request->user() null → AuthorizeLogViewer 403.
        'web',
        AuthorizeLogViewer::class,
    ],
